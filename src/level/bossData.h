		...
		else
		{
			...
			else
			{
				...
				Level::enemiesArray->add(itofix(20), itofix(-20), 100, static_cast<int>(LUTs::BaseImageId::BOSS1_ENEMY_SHIP_SHADOW),
										 static_cast<int>(LUTs::EnemyPatternId::Pattern_1_boss), 0, Constants::SHADOW, true, 0, false, false);
				Level::enemiesArray->add(itofix(300), itofix(-20), 100, static_cast<int>(LUTs::BaseImageId::BOSS1_ENEMY_SHIP_SHADOW),
										 static_cast<int>(LUTs::EnemyPatternId::Pattern_1_boss), 1, Constants::SHADOW, true, 0, false, false);
	...
	else
	{
		...
		if(be->getInternal(31) >= 64)
		{
			...
			Level::enemiesArray->add(itofix(20), itofix(-20), 100, static_cast<int>(LUTs::BaseImageId::BOSS1_ENEMY_SHIP_LIGHT),
									 static_cast<int>(LUTs::EnemyPatternId::Pattern_1_boss), 0, Constants::LIGHT, true, 0, false, false);
			Level::enemiesArray->add(itofix(300), itofix(-20), 100,
									 ...
									 static_cast<int>(LUTs::EnemyPatternId::Pattern_1_boss), 1, be->currentPattern == 1 ? Constants::LIGHT : Constants::SHADOW, true, 0, false, false);
	...
	else if(be->currentPattern == 2)
	{
		...
		if(!(timer % 128))
		{
			...
			if(fireStage < 6)
			{
				pos = getJointPoint(be, boss1_jointData, boss1_joint_leftarm_nonarmed);
				for(int i = 0; i < 4; i++)
					Level::enemiesArray->add(itofix(pos.x), itofix(pos.y), 1, static_cast<int>(LUTs::BaseImageId::BOSS1_GRENADE_LIGHT) + (fireStage % 2), static_cast<int>(LUTs::EnemyPatternId::Pattern_1_bossGrenade), i, fireStage % 2, true, 0, true, false);
			}
			else if(fireStage > 6)
			{
				pos = getJointPoint(be, boss1_jointData, boss1_joint_rightarm_nonarmed);
