...
void cb_Pattern_2_12(cb_args)
{
	if (!(Level::waveTimer % (40 * 2))) // boxes move by a pixel every frame ; let 2 boxes pass by
	{
		...
		Enemy *ce = Level::enemiesArray->add(e->getx(), e->gety(), 20,
											 ...
											 LUTs::EnemyPatternId::BOX, 0, e->internal[0] ? Constants::SHADOW : Constants::LIGHT, 0, 5, false, static_cast<int>(Constants::EnemyType::BREAKABLE_PROP));
...
void cb_Pattern_2_13(cb_args)
{
	if (!(Level::waveTimer % (40 * 2)))
	{
		...
		Enemy *ce = Level::enemiesArray->add(e->getx(), e->gety(), 20,
											 e->internal[0] ? LUTs::BaseImageId::BOX_SHADOW_1 : LUTs::BaseImageId::BOX_LIGHT_1,
											 LUTs::EnemyPatternId::BOX, 0, e->internal[0], 0, 5, false, static_cast<int>(Constants::EnemyType::BREAKABLE_PROP));
...
void cb_Pattern_2_16(cb_args)
{
	if (!(Level::waveTimer % (fixtoi(fixdiv(itofix(40), 256 - Constants::CAMERA_SPEED * 2)))))
	{
		if (e->internal[0] % 2)
		{
			Enemy *ce = Level::enemiesArray->add(e->getx(), e->gety(), 1, LUTs::BaseImageId::BOX_SOLID_1, LUTs::EnemyPatternId::BOX, 0, Constants::LIGHT, 0, 0, false, static_cast<int>(Constants::EnemyType::PROP));
		...
		else
		{
			Enemy *ce = Level::enemiesArray->add(e->getx(), e->gety(), 20,
												 ...
												 LUTs::EnemyPatternId::BOX, 0, e->internal[0] >> 1, 0, 5, false, static_cast<int>(Constants::EnemyType::BREAKABLE_PROP));
...
void cb_Pattern_2_18(cb_args)
{
	...
	if (!(Level::waveTimer % 30))
		Level::enemiesArray->add(fToScreenX(e->getx(), e->getCamRelation()), fToScreenY(e->gety(), e->getCamRelation()), 1, LUTs::BaseImageId::ENEMY_SHIP_1_SHADOW, LUTs::EnemyPatternId::C2_P20, 0, e->polarity, true, 2, false, static_cast<int>(Constants::EnemyType::ENEMY));
	e->beAprop();
}
...
void cb_Pattern_2_19(cb_args)
{
	if (!((Level::waveTimer + 15) % 30))
		Level::enemiesArray->add(fToScreenX(e->getx(), e->getCamRelation()), fToScreenY(e->gety(), e->getCamRelation()), 1, LUTs::BaseImageId::ENEMY_SHIP_1_LIGHT, LUTs::EnemyPatternId::C2_P20, 0, e->polarity, true, 2, false, static_cast<int>(Constants::EnemyType::ENEMY));
	e->beAprop();
}
...
void cb_Pattern_2_30(cb_args)
{
	...
	if (!(GS->chapterTimer % 45))
		Level::enemiesArray->add(fToScreenX(e->getx(), e->getCamRelation()), fToScreenY(e->gety(), e->getCamRelation()), 1, LUTs::BaseImageId::ENEMY_SHIP_1_LIGHT, LUTs::EnemyPatternId::C2_P32, 0, e->polarity, true, 2, false, static_cast<int>(Constants::EnemyType::ENEMY));
	e->beAprop();
}
...
{
	if (!(GS->chapterTimer % 45))
		Level::enemiesArray->add(fToScreenX(e->getx(), e->getCamRelation()), fToScreenY(e->gety(), e->getCamRelation()), 1, LUTs::BaseImageId::ENEMY_SHIP_1_SHADOW, LUTs::EnemyPatternId::C2_P33, 0, e->polarity, true, 2, false, static_cast<int>(Constants::EnemyType::ENEMY));
	e->beAprop();
}
