...
void Level::intro2()
{
	...
	if(!currentW)
	{
		ld1 = enemiesArray->add(itofix(-166 + 83), itofix(120), 1, LUTs::BaseImageId::DOOR_LEFT, LUTs::EnemyPatternId::C2_LEFT_DOOR, 0, Constants::LIGHT, false, 0, true, static_cast<int>(Constants::EnemyType::ENEMY));
		ld2 = enemiesArray->add(itofix(-166 + 83), itofix(-120), 1, LUTs::BaseImageId::DOOR_LEFT, LUTs::EnemyPatternId::C2_LEFT_DOOR, 0, Constants::LIGHT, false, 0, true, static_cast<int>(Constants::EnemyType::ENEMY));
		rd1 = enemiesArray->add(itofix(320 + 83), itofix(120), 1, LUTs::BaseImageId::DOOR_RIGHT, LUTs::EnemyPatternId::C2_RIGHT_DOOR, 0, Constants::LIGHT, false, 0, true, static_cast<int>(Constants::EnemyType::ENEMY));
		rd2 = enemiesArray->add(itofix(320 + 83), itofix(-120), 1, LUTs::BaseImageId::DOOR_RIGHT, LUTs::EnemyPatternId::C2_RIGHT_DOOR, 0, Constants::LIGHT, false, 0, true, static_cast<int>(Constants::EnemyType::ENEMY));
	}
