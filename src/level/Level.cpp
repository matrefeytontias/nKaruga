			...
			else
			{
				...
				if (!skipCommand)
				{
					...
					Enemy *e = enemiesArray->add(itofix(levelStream[counter]), itofix(levelStream[counter + 1]), levelStream[counter + 2],
						static_cast<LUTs::BaseImageId>(levelStream[counter + 3]), static_cast<LUTs::EnemyPatternId>(levelStream[counter + 4]), waveIndex, levelStream[counter + 5],
						levelStream[counter + 6], levelStream[counter + 7], false, static_cast<Constants::EnemyType>(levelStream[counter + 8]));
					if (!prop)
					{
...
void Level::intro2()
{
	...
	if(!currentW)
	{
		ld1 = enemiesArray->add(itofix(-166 + 83), itofix(120), 1, LUTs::BaseImageId::DOOR_LEFT, LUTs::EnemyPatternId::C2_LEFT_DOOR, 0, Constants::LIGHT, false, 0, true, Constants::EnemyType::ENEMY);
		ld2 = enemiesArray->add(itofix(-166 + 83), itofix(-120), 1, LUTs::BaseImageId::DOOR_LEFT, LUTs::EnemyPatternId::C2_LEFT_DOOR, 0, Constants::LIGHT, false, 0, true, Constants::EnemyType::ENEMY);
		rd1 = enemiesArray->add(itofix(320 + 83), itofix(120), 1, LUTs::BaseImageId::DOOR_RIGHT, LUTs::EnemyPatternId::C2_RIGHT_DOOR, 0, Constants::LIGHT, false, 0, true, Constants::EnemyType::ENEMY);
		rd2 = enemiesArray->add(itofix(320 + 83), itofix(-120), 1, LUTs::BaseImageId::DOOR_RIGHT, LUTs::EnemyPatternId::C2_RIGHT_DOOR, 0, Constants::LIGHT, false, 0, true, Constants::EnemyType::ENEMY);
	}
