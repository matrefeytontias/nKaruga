...
public:
	...
	~Enemy();
	void handle();
	void activate(int x, int y, int HP, LUTs::BaseImageId shipImgId, int callbackID, int waveIndex, bool polarity, bool hasRotation, int firebackAmount, bool ghost, int type);
